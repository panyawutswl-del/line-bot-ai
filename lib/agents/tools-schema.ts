...
export const TOOLS: FunctionDeclaration[] = [
  ...
  {
    name: 'checkFloodStatus',
    description: 'เช็คระดับน้ำ/สถานการณ์น้ำท่วมจริงแบบเรียลไทม์ เฉพาะสถานีวัดน้ำในจังหวัดสุโขทัย จากสถาบันสารสนเทศทรัพยากรน้ำ (สสน.) — เรียกใช้ทุกครั้งที่ลูกค้าถามเรื่องน้ำท่วม/สถานการณ์น้ำ/ระดับน้ำแม่น้ำยม',
    parameters: {
      type: Type.OBJECT,
      properties: {},
    },
  ...
  {
    name: 'checkWeather',
    description: 'เช็คสภาพอากาศจริงแบบเรียลไทม์และพยากรณ์ 3 วันข้างหน้าที่บริเวณโรงแรม — เรียกใช้ทุกครั้งที่ลูกค้าถามเรื่องอากาศวันนี้/พรุ่งนี้/ฝนตกไหม/ร้อนไหม เพื่อช่วยแนะนำลูกค้าเตรียมตัว',
    parameters: {
      type: Type.OBJECT,
      properties: {},
    },
