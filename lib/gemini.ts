...
3. ถ้าข้อความขึ้นต้นด้วย [BOOKING_REQUEST] หรือลูกค้าต้องการจองห้องพัก → ตอบว่า:
   "สามารถจองห้องพักออนไลน์ได้เลยที่ลิ้งนี้นะคะ https://hotels.cloudbeds.com/reservation/mQSabb หรือหากต้องการให้เจ้าหน้าที่ช่วยจอง รบกวนติดต่อที่ ${PHONE} ได้เลยค่ะ"
